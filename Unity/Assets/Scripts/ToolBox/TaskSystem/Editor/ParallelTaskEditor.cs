...
{
    [CustomEditor(typeof(ParallelTask), true)]
    public class ParallelTaskEditor : TaskBaseEditor
    {
        private ReorderableList list;
        protected new ParallelTask TargetElement
        {
            get
            {
                return target as ParallelTask;
            }
        }
